...
async def add_bike(bike: AddBike):
    ...
    with open("E:/Ky 8/exe/mvp_50cc/frontend/static/data/user_bikes.json", "a", encoding="utf-8") as f:
...
async def select_bike(bike: SelectBike):
    ...
    vehicles_file = "E:/Ky 8/exe/mvp_50cc/frontend/static/data/vehicles.json"
    if os.path.exists(vehicles_file):
        ...
        if selected_bike:
            ...
            file_path = "E:/Ky 8/exe/mvp_50cc/frontend/static/data/user_bikes.json"
...
async def book_maintenance(booking: MaintenanceBooking):
    with open("E:/Ky 8/exe/mvp_50cc/frontend/static/data/maintenance_bookings.json", "a", encoding="utf-8") as f:
...
async def get_maintenance_history(user_id: int):
    try:
        history = []
        file_path = "E:/Ky 8/exe/mvp_50cc/frontend/static/data/maintenance_bookings.json"
        if os.path.exists(file_path):
            with open(file_path, "r", encoding="utf-8") as f:
